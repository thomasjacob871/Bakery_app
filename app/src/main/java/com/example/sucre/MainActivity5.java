...
public class MainActivity5 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        DatabaseReference ref1 = FirebaseDatabase.getInstance().getReference().child("Cakeu").child("image");
        DatabaseReference ref2=FirebaseDatabase.getInstance().getReference().child("Cakeu").child("name");
        DatabaseReference ref3=FirebaseDatabase.getInstance().getReference().child("Cakeu").child("value");
        ...
        for(int k=0;k<10;k++)
        {
            ...
            imagbut[k].setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    ...
                    Toast.makeText(MainActivity5.this, "Item add successfully to the cart", Toast.LENGTH_SHORT).show();
                }
            });
