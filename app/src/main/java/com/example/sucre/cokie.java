...
public class cokie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cokie);
        ...
        DatabaseReference ref1 = FirebaseDatabase.getInstance().getReference().child("Cookie").child("image");
        DatabaseReference ref2=FirebaseDatabase.getInstance().getReference().child("Cookie").child("name");
        DatabaseReference ref3=FirebaseDatabase.getInstance().getReference().child("Cookie").child("value");
        ...
        for(int k=0;k<10;k++)
        {
            ...
            imagbut[k].setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    ...
                    Toast.makeText(cokie.this, "Item add successfully to the cart", Toast.LENGTH_SHORT).show();
                }
            });
