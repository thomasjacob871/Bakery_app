...
public class Pstrie extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_pstrie);
        ...
        DatabaseReference ref1 = FirebaseDatabase.getInstance().getReference().child("pastrie").child("image");
        DatabaseReference ref2=FirebaseDatabase.getInstance().getReference().child("pastrie").child("name");
        DatabaseReference ref3=FirebaseDatabase.getInstance().getReference().child("pastrie").child("value");
        ...
        for(int k=0;k<10;k++)
        {
            ...
            imagbut[k].setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    ...
                    Toast.makeText(Pstrie.this, "Item add successfully to the cart", Toast.LENGTH_SHORT).show();
                }
            });
