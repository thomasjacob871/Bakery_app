...
public class Biscuit extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        DatabaseReference ref1 = FirebaseDatabase.getInstance().getReference().child("Biscuits").child("image");
        DatabaseReference ref2=FirebaseDatabase.getInstance().getReference().child("Biscuits").child("name");
        DatabaseReference ref3=FirebaseDatabase.getInstance().getReference().child("Biscuits").child("price");
        ...
        for(int k=0;k<10;k++)
        {
            ...
            imagbut[k].setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    ...
                    Toast.makeText(Biscuit.this, "Item add successfully to the cart", Toast.LENGTH_SHORT).show();
                }
            });
